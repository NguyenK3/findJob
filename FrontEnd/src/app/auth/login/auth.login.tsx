  ...
  return (
    ...
    >
      ...
      >
        ...
        <Typography sx={{ mb: 2, textAlign: 'center', fontSize: '0.9rem' }}>hoặc</Typography>
        ...
        >
          ...
          />
          <a href="/forgot-password" style={{ color: '#FF5722', textDecoration: 'none' }}>
            Quên mật khẩu?
          </a>
        </Box>
        ...
        >
          ...
          <a href="/register" style={{ color: '#FF5722', textDecoration: 'none' }}>
            Đăng ký ngay
          </a>
        </Typography>
      </Box>
